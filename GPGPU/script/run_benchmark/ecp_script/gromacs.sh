...
# mpirun -np 8 gmx_mpi mdrun -v -deffnm em -nb cpu 
# mpirun -np 8 gmx_mpi mdrun -v -deffnm em -nb cpu 
# mpirun -np 8 gmx_mpi mdrun -v -deffnm em -nb cpu 


mpirun -np 1 gmx_mpi mdrun -v -deffnm md -nb gpu -pme gpu -bonded gpu -update gpu -nsteps 5000
...
# mpirun -np 1 gmx_mpi mdrun -v -deffnm md -nb gpu -pme gpu -bonded gpu -update gpu -nsteps 500
